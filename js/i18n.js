(() => {
  ...
  const catalogs = {
    'en-US': {
      ...
      'O Lyra OS Desktop Alpha 7 com GNOME já está disponível. As demais imagens continuam em publicação.': 'Lyra OS Desktop Alpha 7 with GNOME is now available. The remaining images are still being published.',
