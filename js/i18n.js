(() => {
  ...
  const catalogs = {
    'en-US': {
      ...
      'KDE Plasma e XFCE estão sendo preparados como versões experimentais solicitadas pela comunidade. Ainda não há imagens disponíveis.': 'KDE Plasma and XFCE are being prepared as experimental versions requested by the community. No images are available yet.',
