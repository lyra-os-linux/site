(() => {
  ...
  const catalogs = {
    'en-US': {
      ...
      'O Lyra OS Desktop Alpha 7 com GNOME e KDE Plasma e o Server Beta 1 já estão disponíveis. A imagem XFCE continua em publicação.': 'Lyra OS Desktop Alpha 7 with GNOME and KDE Plasma and Server Beta 1 are now available. The XFCE image is still being published.',
  ...
  Object.assign(catalogs['es-ES'], {
    ...
    'O Lyra OS Desktop Alpha 7 com GNOME e KDE Plasma e o Server Beta 1 já estão disponíveis. A imagem XFCE continua em publicação.':'Lyra OS Desktop Alpha 7 con GNOME y KDE Plasma y Server Beta 1 ya están disponibles. La imagen XFCE sigue en proceso de publicación.',
