(() => {
  ...
  const catalogs = {
    'en-US': {
      ...
      'Versões experimentais': 'Experimental versions', 'Fechar versões experimentais': 'Close experimental versions', 'Laboratório Lyra': 'Lyra Lab',
      'Outros desktops,': 'Other desktops,', 'novas possibilidades.': 'new possibilities.',
      'KDE Plasma e XFCE estão sendo preparados como flavors experimentais. Ainda não há imagens disponíveis para download.': 'KDE Plasma and XFCE are being prepared as experimental flavors. No downloadable images are available yet.',
      'Em preparação': 'In preparation', 'Não disponível': 'Unavailable',
      'Uma experiência moderna e flexível, desenvolvida em ciclo separado da edição oficial.': 'A modern, flexible experience developed on a separate cycle from the official edition.',
      'Um flavor leve e direto, planejado com os mesmos critérios de estabilidade e validação.': 'A lightweight, straightforward flavor planned with the same stability and validation criteria.',
      'A edição Desktop com GNOME continua sendo a opção oficial e recomendada.': 'The GNOME Desktop edition remains the official, recommended option.',
  ...
  Object.assign(catalogs['en-US'], {
    ...
    'A linha Lyra OS baseada em openSUSE Leap 16 terá suporte até outubro de 2032. Cada release (27.02...) mantém seu próprio ciclo de suporte e pode exigir a migração para um release mais recente.':'The Lyra OS line based on openSUSE Leap 16 will be supported through October 2032. Each release (27.02...) has its own support cycle and may require an upgrade to a newer release.',
    '“27.02” é a versão canônica do ciclo no padrão ano.mês (estilo Ubuntu), inclusive nos metadados internos de release. O Lyra OS terá suporte até outubro de 2032.':'“27.02” is the canonical cycle version in the year.month pattern, including internal release metadata. Lyra OS will be supported through October 2032.',
  ...
  Object.assign(catalogs['es-ES'], {
    'Política de melhorias e congelamento funcional':'Política de mejoras y congelación funcional','Melhorias liberadas nas Betas da 27.02 · congelamento estrito na RC1':'Mejoras permitidas en las Betas de 27.02 · congelación estricta en RC1','Desktop e Server podem receber melhorias durante as Betas quando os ganhos compensarem os riscos, com análise, testes de regressão e plano de reversão. P0/P1 não passa para a etapa seguinte.':'Desktop y Server pueden recibir mejoras durante las Betas cuando los beneficios compensen los riesgos, con análisis, pruebas de regresión y plan de reversión. Los P0/P1 no pasan a la siguiente etapa.',
    ...
    'A linha Lyra OS baseada em openSUSE Leap 16 terá suporte até outubro de 2032. Cada release (27.02...) mantém seu próprio ciclo de suporte e pode exigir a migração para um release mais recente.':'La línea Lyra OS basada en openSUSE Leap 16 tendrá soporte hasta octubre de 2032. Cada versión (27.02...) mantiene su propio ciclo de soporte y puede requerir una actualización.',
    '“27.02” é a versão canônica do ciclo no padrão ano.mês (estilo Ubuntu), inclusive nos metadados internos de release. O Lyra OS terá suporte até outubro de 2032.':'“27.02” es la versión canónica del ciclo con el patrón año.mes (al estilo Ubuntu), incluso en los metadatos internos de la versión. Lyra OS tendrá soporte hasta octubre de 2032.',
