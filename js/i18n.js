(() => {
  ...
  const catalogs = {
    'en-US': {
      ...
      'A linha Lyra OS baseada em openSUSE Leap 16 terá suporte até uma política formal. Cada release (1.0, uma release futura...) mantém seu próprio ciclo de suporte e pode exigir a migração para um release mais recente.': 'The Lyra OS line based on openSUSE Leap 16 will be supported through a formal policy. Each release (1.0, uma release futura...) has its own support cycle and may require an upgrade to a newer release.',
      '“1.0” e “uma release futura” são as versões canônicas dos ciclos no padrão MAJOR.MINOR.PATCH (estilo Ubuntu), inclusive nos metadados internos de release. O Lyra OS terá suporte até uma política formal.': '“1.0” and “uma release futura” are the canonical cycle versions in the MAJOR.MINOR.PATCH pattern (Ubuntu-style), including internal release metadata. Lyra OS will be supported through a formal policy.',
      ...
      'Suporte encerra em 31 de outubro de 2027, junto com o fim de vida da base openSUSE Leap 16.1; a migração para a Lyra OS uma release futura (base Leap 16.1) deve ocorrer antes dessa data.': 'Support ends on October 31, 2027, alongside the end of life of the openSUSE Leap 16.1 base; migration to Lyra OS uma release futura (Leap 16.1 base) must take place before that date.',
      'Suporte encerra em 31 de outubro de 2027, junto com o fim de vida da base openSUSE Leap 16.1; a migração para a Lyra OS Server uma release futura (base Leap 16.1) deve ocorrer antes dessa data.': 'Support ends on October 31, 2027, alongside the end of life of the openSUSE Leap 16.1 base; migration to Lyra OS Server uma release futura (Leap 16.1 base) must take place before that date.',
      ...
      '06 ago 2026': 'Aug 6, 2026', 'base openSUSE Leap 16.1': 'openSUSE Leap 16.1 base',
      ...
      'Flavors oficiais': 'Official flavors', 'Fechar flavors oficiais': 'Close official flavors', 'Flavors do Lyra OS': 'Lyra OS flavors',
      'Flavors oficiais,': 'Official flavors,', 'em desenvolvimento.': 'in development.',
      'KDE Plasma e XFCE serão flavors oficiais do Lyra OS. As imagens ainda estão em preparação.': 'KDE Plasma and XFCE will be official Lyra OS flavors. Images are still being prepared.',
      ...
      'XFCE próximo dos padrões do openSUSE, com uma seleção pequena e manutenção simples.': 'XFCE close to openSUSE defaults, with a small selection and simple maintenance.',
      ...
      'O Lyra OS é uma distribuição Linux brasileira baseada no openSUSE Leap 16.1, desenvolvida para oferecer uma experiência moderna, elegante e extremamente estável.': 'Lyra OS is a Brazilian Linux distribution based on openSUSE Leap 16.1, built to provide a modern, elegant, and highly stable experience.',
  ...
  Object.assign(catalogs['es-ES'], catalogs['en-US'], {
    ...
    'Política de suporte do Lyra OS':'Política de soporte de Lyra OS','Lyra OS com suporte até uma política formal':'Lyra OS con soporte hasta una política formal','A linha Lyra OS baseada em openSUSE Leap 16 terá suporte até uma política formal. Cada release (1.0, uma release futura...) mantém seu próprio ciclo de suporte e pode exigir a migração para um release mais recente.':'La línea Lyra OS basada en openSUSE Leap 16 tendrá soporte hasta una política formal. Cada versión (1.0, uma release futura...) mantiene su propio ciclo de soporte y puede requerir la actualización a una versión más reciente.','“1.0” e “uma release futura” são as versões canônicas dos ciclos no padrão MAJOR.MINOR.PATCH (estilo Ubuntu), inclusive nos metadados internos de release. O Lyra OS terá suporte até uma política formal.':'“1.0” y “uma release futura” son las versiones canónicas de los ciclos con el patrón MAJOR.MINOR.PATCH (al estilo Ubuntu), incluso en los metadatos internos de la versión. Lyra OS tendrá soporte hasta una política formal.',
  ...
  Object.assign(catalogs['es-ES'], {
    ...
    'Fim de suporte da Lyra OS Server 1.0':'Fin del soporte de Lyra OS Server 1.0','Suporte encerra em 31 de outubro de 2027, junto com o fim de vida da base openSUSE Leap 16.1; a migração para a Lyra OS Server uma release futura (base Leap 16.1) deve ocorrer antes dessa data.':'El soporte termina el 31 de octubre de 2027, junto con el fin de vida de la base openSUSE Leap 16.1; la migración a Lyra OS Server uma release futura (base Leap 16.1) debe realizarse antes de esa fecha.',
  ...
  Object.assign(catalogs['en-US'], {
    ...
    'A linha Lyra OS baseada em openSUSE Leap 16 terá suporte até uma política formal. Cada release (1.0...) mantém seu próprio ciclo de suporte e pode exigir a migração para um release mais recente.':'The Lyra OS line based on openSUSE Leap 16 will be supported through a formal policy. Each release (1.0...) has its own support cycle and may require an upgrade to a newer release.',
    '“1.0” é a versão canônica do ciclo no padrão MAJOR.MINOR.PATCH (estilo Ubuntu), inclusive nos metadados internos de release. O Lyra OS terá suporte até uma política formal.':'“1.0” is the canonical cycle version in the MAJOR.MINOR.PATCH pattern, including internal release metadata. Lyra OS will be supported through a formal policy.',
    'migração para openSUSE Leap 16.1 na Alpha 7':'migration to openSUSE Leap 16.1 in Alpha 7','migração para openSUSE Leap 16.1 na Beta 2':'migration to openSUSE Leap 16.1 in Beta 2',
    '2 SEMANAS · REBASE + PRODUTO COMPLETO':'2 WEEKS · REBASE + COMPLETE PRODUCT','Migração para Leap 16.1 Beta 1 e requalificação integral; interface e upgrade entre releases; configuração parental e autorização de aplicativos no Vega.':'Migration to Leap 16.1 Beta 1 and full requalification; interface and cross-release upgrade; parental configuration and app authorization in Vega.',
    '4 SEMANAS · REBASE':'4 WEEKS · REBASE','Objetivo: migrar para Leap 16.1 e requalificar build, instalação, Secure Boot, atualizações, rede e administração remota.':'Objective: migrate to Leap 16.1 and requalify the build, installation, Secure Boot, updates, networking, and remote administration.',
    'Estimativa sujeita à confirmação do ciclo de suporte do openSUSE Leap 16.1.':'Estimate subject to confirmation of the openSUSE Leap 16.1 support lifecycle.'
  });

  Object.assign(catalogs['es-ES'], {
    'Política de melhorias e congelamento funcional':'Política de mejoras y congelación funcional','Melhorias liberadas nas Betas da 1.0 · congelamento estrito na RC1':'Mejoras permitidas en las Betas de 1.0 · congelación estricta en RC1','Desktop e Server podem receber melhorias durante as Betas quando os ganhos compensarem os riscos, com análise, testes de regressão e plano de reversão. P0/P1 não passa para a etapa seguinte.':'Desktop y Server pueden recibir mejoras durante las Betas cuando los beneficios compensen los riesgos, con análisis, pruebas de regresión y plan de reversión. Los P0/P1 no pasan a la siguiente etapa.',
    ...
    'A linha Lyra OS baseada em openSUSE Leap 16 terá suporte até uma política formal. Cada release (1.0...) mantém seu próprio ciclo de suporte e pode exigir a migração para um release mais recente.':'La línea Lyra OS basada en openSUSE Leap 16 tendrá soporte hasta una política formal. Cada versión (1.0...) mantiene su propio ciclo de soporte y puede requerir una actualización.',
    '“1.0” é a versão canônica do ciclo no padrão MAJOR.MINOR.PATCH (estilo Ubuntu), inclusive nos metadados internos de release. O Lyra OS terá suporte até uma política formal.':'“1.0” es la versión canónica del ciclo con el patrón MAJOR.MINOR.PATCH (al estilo Ubuntu), incluso en los metadatos internos de la versión. Lyra OS tendrá soporte hasta una política formal.',
    'migração para openSUSE Leap 16.1 na Alpha 7':'migración a openSUSE Leap 16.1 en Alpha 7','migração para openSUSE Leap 16.1 na Beta 2':'migración a openSUSE Leap 16.1 en Beta 2',
  ...
  Object.assign(catalogs['en-US'], {
    ...
    'Para ambas as edições:':'For both editions:','firmware UEFI, mídia USB para instalação e conexão com a internet para atualizações. Secure Boot é suportado. A instalação usa o disco inteiro; no Server 1.0, o instalador ainda não oferece RAID nem LVM. Requisitos provisórios, sujeitos à ampliação da matriz de hardware durante a Beta.':'UEFI firmware, a USB installation drive, and an internet connection for updates. Secure Boot is supported. Installation uses the entire disk; in Server 1.0, the installer does not yet offer RAID or LVM. These requirements are provisional and subject to broader hardware qualification during Beta.'
  });
  ...
  Object.assign(catalogs['es-ES'], {
    ...
    'Para ambas as edições:':'Para ambas ediciones:','firmware UEFI, mídia USB para instalação e conexão com a internet para atualizações. Secure Boot é suportado. A instalação usa o disco inteiro; no Server 1.0, o instalador ainda não oferece RAID nem LVM. Requisitos provisórios, sujeitos à ampliação da matriz de hardware durante a Beta.':'firmware UEFI, unidad USB de instalación y conexión a internet para actualizaciones. Secure Boot es compatible. La instalación utiliza todo el disco; en Server 1.0, el instalador aún no ofrece RAID ni LVM. Estos requisitos son provisionales y están sujetos a una validación de hardware más amplia durante la Beta.'
  });

  Object.assign(catalogs['en-US'], {
    'Lyra OS 1.0 em desenvolvimento':'Lyra OS 1.0 in development',
    'Versão do produto':'Product version','Base tecnológica':'Technology base',
    'Suporte comunitário':'Community support',
    'O Lyra OS 1.0 terá suporte comunitário. A geração pode evoluir por releases 1.x com caminhos suportados de atualização. O suporte da base openSUSE e o ciclo de cada release Lyra são informações distintas; não há promessa de prazo ou EOL sem uma política formal.':'Lyra OS 1.0 will have community support. The generation may evolve through 1.x releases with supported upgrade paths. openSUSE base support and each Lyra release lifecycle are separate; no support term or EOL is promised without a formal policy.',
    'LANÇAMENTO PREVISTO · SUJEITO AO GATE':'PLANNED RELEASE · SUBJECT TO THE GATE','20 fev 2027':'Feb 20, 2027',
    'Desktop · GNOME':'Desktop · GNOME','Desktop · KDE Plasma':'Desktop · KDE Plasma','Desktop · XFCE':'Desktop · XFCE',
    '20 GiB':'20 GiB','SSD de 32 GiB ou mais':'32 GiB SSD or more',
    'Para todas as edições e flavors:':'For all editions and flavors:',
    'firmware UEFI, mídia USB para instalação e conexão com a internet para atualizações. Secure Boot é suportado. GNOME e KDE Plasma usam o mesmo perfil-base; o XFCE reduz o consumo esperado, mas mantém margem para atualizações. A instalação usa o disco inteiro; no Server 1.0, o instalador ainda não oferece RAID nem LVM. Requisitos provisórios, sujeitos à validação do gate e da matriz de hardware.':'UEFI firmware, a USB installation drive, and an internet connection for updates. Secure Boot is supported. GNOME and KDE Plasma use the same baseline profile; XFCE lowers expected resource use while retaining update headroom. Installation uses the entire disk; Server 1.0 does not yet offer RAID or LVM. Requirements are provisional and subject to gate and hardware-matrix validation.',
  ...
  Object.assign(catalogs['es-ES'], {
    ...
    'Para todas as edições e flavors:':'Para todas las ediciones y flavors:',
