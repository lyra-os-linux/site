(() => {
  ...
  const catalogs = {
    'en-US': {
      ...
      'As quatro opções oferecem a mesma base do Lyra OS, com experiências de uso diferentes.': 'All four options share the same Lyra OS base, with different user experiences.',
      ...
      'Baixar GNOME': 'Download GNOME', 'Baixar KDE': 'Download KDE', 'Baixar XFCE': 'Download XFCE', 'Baixar LXQt': 'Download LXQt',
      'Leve, rápido e modular, com uma experiência clássica para computadores com menos recursos.': 'Lightweight, fast, and modular, with a classic experience for computers with fewer resources.',
  ...
  Object.assign(catalogs['en-US'], {
    ...
    'Desktop · GNOME':'Desktop · GNOME','Desktop · KDE Plasma':'Desktop · KDE Plasma','Desktop · XFCE':'Desktop · XFCE','Desktop · LXQt':'Desktop · LXQt','Desktop · GNOME e KDE Plasma':'Desktop · GNOME and KDE Plasma','Desktop · XFCE e LXQt':'Desktop · XFCE and LXQt',
    '20 GiB':'20 GiB','SSD de 32 GiB ou mais':'32 GiB SSD or more',
    'Para todas as edições do Desktop:':'For all Desktop editions:',
    'firmware UEFI, mídia USB para instalação e conexão com a internet para atualizações. Secure Boot é suportado. GNOME e KDE Plasma usam o mesmo perfil-base; XFCE e LXQt reduzem o consumo esperado, mas mantêm margem para atualizações. A instalação usa o disco inteiro; no Server 1.0, o instalador ainda não oferece RAID nem LVM. Requisitos provisórios, sujeitos à validação do gate e da matriz de hardware.':'UEFI firmware, a USB installation drive, and an internet connection for updates. Secure Boot is supported. GNOME and KDE Plasma use the same baseline profile; XFCE and LXQt lower expected resource use while retaining update headroom. Installation uses the entire disk; Server 1.0 does not yet offer RAID or LVM. Requirements are provisional and subject to gate and hardware-matrix validation.',
  ...
  Object.assign(catalogs['es-ES'], {
    ...
    'Desktop · GNOME':'Desktop · GNOME','Desktop · KDE Plasma':'Desktop · KDE Plasma','Desktop · XFCE':'Desktop · XFCE','Desktop · LXQt':'Desktop · LXQt','Desktop · GNOME e KDE Plasma':'Desktop · GNOME y KDE Plasma','Desktop · XFCE e LXQt':'Desktop · XFCE y LXQt',
    ...
    'As quatro opções oferecem a mesma base do Lyra OS, com experiências de uso diferentes.':'Las cuatro opciones comparten la misma base de Lyra OS, con experiencias de uso diferentes.',
    ...
    'Baixar GNOME':'Descargar GNOME','Baixar KDE':'Descargar KDE','Baixar XFCE':'Descargar XFCE','Baixar LXQt':'Descargar LXQt',
    'Leve, rápido e modular, com uma experiência clássica para computadores com menos recursos.':'Ligero, rápido y modular, con una experiencia clásica para computadoras con menos recursos.',
    'firmware UEFI, mídia USB para instalação e conexão com a internet para atualizações. Secure Boot é suportado. GNOME e KDE Plasma usam o mesmo perfil-base; XFCE e LXQt reduzem o consumo esperado, mas mantêm margem para atualizações. A instalação usa o disco inteiro; no Server 1.0, o instalador ainda não oferece RAID nem LVM. Requisitos provisórios, sujeitos à validação do gate e da matriz de hardware.':'firmware UEFI, unidad USB de instalación y conexión a internet para actualizaciones. Secure Boot es compatible. GNOME y KDE Plasma usan el mismo perfil base; XFCE y LXQt reducen el consumo esperado y conservan margen para actualizaciones. La instalación utiliza todo el disco; Server 1.0 aún no ofrece RAID ni LVM. Los requisitos son provisionales y están sujetos al gate y a la matriz de hardware.',
