(() => {
  ...
  const catalogs = {
    'en-US': {
      ...
      'O Lyra OS Desktop Alpha 7 com GNOME e o Server Beta 1 já estão disponíveis.': 'Lyra OS Desktop Alpha 7 with GNOME and Server Beta 1 are now available.',
      ...
      'Lyra OS Desktop': 'Lyra OS Desktop',
      'Baixar o Lyra OS': 'Download Lyra OS',
  ...
  Object.assign(catalogs['es-ES'], {
    ...
    'Lyra OS Desktop · GNOME com o papel de parede Odisseia':'Lyra OS Desktop · GNOME con el fondo de pantalla Odisseia',
  ...
  Object.assign(catalogs['es-ES'], {
    ...
    'Para o Desktop:':'Para Desktop:',
    'Lyra OS Desktop':'Lyra OS Desktop',
    'O Lyra OS Desktop Alpha 7 com GNOME e o Server Beta 1 já estão disponíveis.':'Lyra OS Desktop Alpha 7 con GNOME y Server Beta 1 ya están disponibles.',
    'Baixar o Lyra OS':'Descargar Lyra OS',
    'firmware UEFI, mídia USB para instalação e conexão com a internet para atualizações. Secure Boot é suportado. A instalação usa o disco inteiro; no Server 1.1, o instalador ainda não oferece RAID nem LVM. Requisitos provisórios, sujeitos à validação do gate e da matriz de hardware.':'firmware UEFI, unidad USB de instalación y conexión a internet para actualizaciones. Secure Boot es compatible. La instalación utiliza todo el disco; Server 1.1 aún no ofrece RAID ni LVM. Los requisitos son provisionales y están sujetos al gate y a la matriz de hardware.',
